...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<xsl:element name="csw:GetRecords" use-attribute-sets="GetRecordsAttributes" xmlns:csw="http://www.opengis.net/cat/csw/2.0.2"
			xmlns:ogc="http://www.opengis.net/ogc" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:gml="http://www.opengis.net/gml"
			...
			<csw:Query typeNames="gmd:MD_Metadata">
				...
				<csw:Constraint version="1.1.0">
					<ogc:Filter xmlns="http://www.opengis.net/ogc">
						...
						<xsl:if test="count(exsl:node-set($filter)/*) > 0">
							<!-- Output filter expression only if not empty -->
							<ogc:And>
	...
	<!-- <ogc:PropertyIsLessThanOrEqualTo> <ogc:PropertyName>apiso:TempExtent_begin</ogc:PropertyName> <ogc:Literal>2011-01-30T23:00:00</ogc:Literal> 
		</ogc:PropertyIsLessThanOrEqualTo> <ogc:PropertyIsGreaterThan> <ogc:PropertyName>apiso:TempExtent_end</ogc:PropertyName> 
		<ogc:Literal>2008-01-10T23:00:00</ogc:Literal> </ogc:PropertyIsGreaterThan> -->
